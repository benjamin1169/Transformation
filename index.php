	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="view/donate.php" class="nav-link">Donate</a></li>
	          ...
	          <li class="nav-item cta"><a href="view/book.php" class="nav-link">Book an Appointment</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="./view/reservation.php" class="btn btn-primary p-3 px-xl-4 py-xl-3">Book Now</a> <a href="./view/service.php" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Services</a></p>
            </div>
