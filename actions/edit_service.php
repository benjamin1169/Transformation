...
//db insertion
    ...
    $result = updateservice($service_id, $service_cat,$service_brand,
    $service_title,$service_price,$service_desc,$upload_file_dest,$service_keywords);
    if ($result) {
        session_start();
        $_SESSION["service_upt"] = true;
        header("location: ../view/service_display.php");
    } else {
