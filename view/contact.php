...
<html lang="en">
  ...
  <?php
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <li class="nav-item "><a href="../view/about.php" class="nav-link">About</a></li>
	          ...
	          <li class="nav-item active"><a href="../view/contact.php" class="nav-link">Contact</a></li>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('../images/[GetPaidStock.com]-63717a99443e0.jpeg');" data-stellar-background-ratio="0.5">
