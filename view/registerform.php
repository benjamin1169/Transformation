...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('../images/[GetPaidStock.com]-6375853931b51.jpeg');"></div>
    <div class="contents order-2 order-md-1">
      ...
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-7">
            <h3>Register for <strong>The Transformation Salon</strong></h3>
            <p class="mb-4">Welcome to the Transformation Salon. Kindly Sign Up</p>
            ...
            <div class="form-group first">
              ...
              <div class="form-group first">
                ...
                <input type="text" name="email" class="form-control" placeholder="youremail@gmail.com" id="email" required>
              </div>
              <div class="form-group last mb-3">
                <label for="password">Password</label>
                <input type="password" name="password" class="form-control" placeholder="Enter a Password" id="password" required>
              </div>
              <div class="form-group last mb-3">
                <label for="password">Contact</label>
                <input type="text" name="contact" class="form-control" placeholder="Enter your mobile number" id="contact" required>
              </div>
              

              <input type="submit" name="Register" value="Register" class="btn btn-block btn-primary">
              <br>
              <p>Already registered? <a href="./login_form.php">Log In</a></p>
...
<!-- <div class="signup__container">
  <div class="container__child signup__thumbnail">
    ...
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to The Transformation Salon.</h1>
      <h2 class="heading--secondary">Are you ready to enjoy the experience?</h2>
    </div>
  ...
  <div class="container__child signup__form">
    <form action="../actions/registerprocess.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="email" id="email" placeholder="Enter your email address" required />
      </div>
      <div class="form-group">
        <label for="password">Password</label>
      ...
      <label for="contact">Contact</label>
        <input class="form-control" type="number" name="contact" id="contact" placeholder="Enter your mobile number" required />
      </div>
      <div class="m-t-lg">
        <ul class="list-inline">
          ...
          <li>
            <a class="signup__link" href="../view/login_form.php">I am already a member</a>
          </li>
        </ul>
      </div>
    </form>  
