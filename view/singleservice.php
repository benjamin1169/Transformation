...
<!-- 
        ...
        <div class='viewoneservice' style='display: flex; margin-top: 200px; margin-left: 450px;'>
        <!-- <form method = POST action="viewallproduct.php" -->
            ...
            <div class='content' style='margin-left: 70px'>
                ...
                <h4><?php echo $product['service_name'] ?></h4>
                <h4 style='color: grey;'> <?php echo $service['service_price'] ?></h4>
                <h5 style='color: grey;'><?php echo $product['service_desc'] ?></h5>
